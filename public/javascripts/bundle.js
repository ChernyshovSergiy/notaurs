...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZW5lYnJhIiwiYSI6ImNrOGliY2l1OTAxMjMzZnJ6NWRpZXBjbTUifQ.hwW5mTQ3x8Rg318RPyn-lQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/enebra/ck8idyyyl2ano1inyfc70a6hn',
    // style: 'mapbox://styles/enebra/ck8idubas2a921inyjt251vq9',
    scrollZoom: false //// All options see: https://docs.mapbox.com/mapbox-gl-js/api/
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Add to Popup
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'LogIn is successfully');
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _res = _context2.sent;
            if (_res.data.status) location.reload(true);
            (0, _alerts.showAlert)('success', 'Bye! See you next time!', 10000);
            _context2.next = 11;
            break;
...
var logOutButton = document.querySelector('.nav__el--logout'); //DELEGATIONS
